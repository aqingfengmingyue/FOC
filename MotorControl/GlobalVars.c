...
SMO_HandleTypeDef smo = {
    .Rs = 6.97f,    // 定子电阻 6.97Ω
    .Ld = 0.00535f, // d轴电感 0.00535mH
    .Lq = 0.00535f, // q轴电感 0.00535mH
    .Ts = 0.0001f,  // 采样时间 100us (10kHz)
    .Kslide = 24.0f,
    .i_alpha_est = 0.0f,
    .i_beta_est = 0.0f,
    .z_alpha = 0.0f,
...
LPF_HandleTypeDef lpf_alpha = {
    .alpha = 0.351f,
    .y_prev = 0.0f};

LPF_HandleTypeDef lpf_beta = {
    .alpha = 0.351f,
    .y_prev = 0.0f};
